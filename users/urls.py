...
urlpatterns = [
    ...
    path('password/reset/done', PasswordResetDoneView.as_view(template_name='regisuserstration/password_reset_done.html'), name='password_reset_done'),
    ...
    path('password/reset/complete', PasswordResetCompleteView.as_view(template_name='users/password_reset_comlete.html'), name='password_reset_complete'),
]