...
urlpatterns = [
    path('password/reset/', PasswordResetView.as_view(template_name='users/password_reset_form.html'), html_email_template_name='users/password_reset_email.html', name='password_reset'),
